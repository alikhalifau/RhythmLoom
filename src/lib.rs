...
#[derive(Debug)]
pub struct RhythmLoomProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RhythmLoomProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RhythmLoom processing");
    
    let mut processor = RhythmLoomProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RhythmLoomProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RhythmLoomProcessor::new(false);
